...
| --------	| -------------			| -------------			| ------------			|
| x			| turtle.x = arg		| turtle.x += arg		| strafe by arg			|
...
Some of them could conceivably, but it would be like an extra feature that you could turn on, a bit like the xyTurn command I have now.
